...
impl ActivePageTable {
    ...
    {   // eeh self
        use self::x86_64::instructions::tlb; // eeh self
        use self::x86_64::registers::control_regs;// eeh self
        // eeh self
        {
    ...
    pub fn switch(&mut self, new_table: InactivePageTable) -> InactivePageTable {
        use self::x86_64::PhysicalAddress; //self?
        use self::x86_64::registers::control_regs; //self?
