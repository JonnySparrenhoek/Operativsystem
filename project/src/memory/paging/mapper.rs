...
impl Mapper {
    ...
    {
        //let p4 = self.p4_mut(); INTE MED I MIN UTKOMMENTERAD
        //let p4 = unsafe { &mut *P4 }; INTE MED I MIN UTKOMMENTERAD
    //    let mut p3 = self.p4_mut().next_table_create(page.p4_index(), allocator); //MED I MIN
        let p4 = self.p4_mut();
    ...
    pub fn unmap<A>(&mut self, page: Page, allocator: &mut A)
        where A: FrameAllocator
    {
        use memory::paging::x86_64::instructions::tlb;
        use memory::paging::x86_64::VirtualAddress;
